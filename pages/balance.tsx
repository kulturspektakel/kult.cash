  ...
  return (
    <div className={styles.root}>
              ...
              <g>
                ...
                <g>
                  ...
                  <g>
                    ...
                    />
                    <path
                      d="M82.28,21.13v4.72h2.83v1H81.26V21.13Z"
                      fill="#fff"
                    />
                  </g>
                  <g>
      ...
      <div className={styles.info}>
        <div className={styles.aspect}></div>
        Das Gut&shy;haben der Karte kann an den Bon&shy;buden aus&shy;gezahlt
        werden. Auf der Karte selbst sind 2&nbsp;Euro Karten&shy;pfand.
      </div>
    </div>
  );
}

Balance.getInitialProps = async ({query}: NextPageContext) => query;
